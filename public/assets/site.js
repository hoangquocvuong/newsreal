...
async function nrBootMain(){
 try{
   ...
   document.body.classList.toggle('theme-showcase-new',['personal_blog_1','personal_blog_2','corporate_modern_1','corporate_industry_2','service_ev_charge_5'].includes(effectivePreset));
