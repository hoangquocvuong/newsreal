...
body:has(.shop18){background:#fff}.shop18{--ink:#171717;--muted:#717171;--line:#e9e9e9;--accent:#ff5a1f;--soft:#fff5ef;font-family:Inter,system-ui,-apple-system,Segoe UI,sans-serif;color:var(--ink);background:#fff;min-height:100vh}.shop18 *{box-sizing:border-box}.s18-wrap{width:min(1240px,calc(100% - 40px));margin:auto}.s18-ann{background:#171717;color:#fff;text-align:center;padding:9px 16px;font-size:12px;letter-spacing:.02em}.s18-head{background:#fff;border-bottom:1px solid var(--line);position:sticky;top:0;z-index:40}.s18-headrow{height:82px;display:grid;grid-template-columns:190px minmax(320px,1fr) auto;align-items:center;gap:26px}.s18-brand{text-decoration:none;color:var(--ink);font-weight:950;font-size:26px;letter-spacing:-1.2px}.s18-brand em{font-style:normal;color:var(--accent)}.s18-search{height:48px;background:#f6f6f6;border-radius:999px;display:flex;padding-left:18px;overflow:hidden;border:1px solid transparent}.s18-search:focus-within{border-color:#d8d8d8;background:#fff}.s18-search input{flex:1;border:0;outline:0;background:transparent;font-size:14px}.s18-search button{border:0;background:var(--accent);color:#fff;font-weight:850;padding:0 24px;cursor:pointer}.s18-actions{display:flex;gap:9px}.s18-actions a,.s18-actions button{height:44px;border:1px solid var(--line);background:#fff;border-radius:999px;padding:0 15px;display:flex;align-items:center;text-decoration:none;color:var(--ink);font-weight:800;cursor:pointer}.s18-actions .bag{background:var(--ink);color:#fff;border-color:var(--ink)}.s18-nav{border-top:1px solid #f3f3f3}.s18-nav .s18-wrap{height:48px;display:flex;align-items:center;gap:28px;overflow:auto;scrollbar-width:none}.s18-nav a{color:#454545;text-decoration:none;font-size:13px;font-weight:750;white-space:nowrap}.s18-nav a.hot{color:var(--accent)}.s18-hero{padding:28px 0 16px}.s18-hero-grid{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(300px,.65fr);gap:16px}.s18-hero-main{min-height:410px;border-radius:30px;background:#f2efe9;overflow:hidden;display:grid;grid-template-columns:1.05fr .95fr;align-items:center;padding:54px;position:relative}.s18-kicker{font-size:12px;font-weight:900;letter-spacing:.16em;color:var(--accent)}.s18-hero-main h1{font-size:52px;line-height:1.02;letter-spacing:-2.7px;margin:13px 0 16px;max-width:620px}.s18-hero-main p{font-size:15px;line-height:1.7;color:#666;max-width:500px;margin:0 0 25px}.s18-cta{display:inline-flex;padding:13px 20px;border-radius:999px;background:var(--ink);color:#fff;text-decoration:none;font-weight:850}.s18-hero-main img{width:100%;height:330px;object-fit:contain;filter:drop-shadow(0 25px 35px rgba(0,0,0,.12))}.s18-promos{display:grid;gap:16px}.s18-promo{border-radius:30px;padding:28px;min-height:197px;display:flex;flex-direction:column;justify-content:flex-end;background:#dff4ea}.s18-promo:last-child{background:#fce7ef}.s18-promo small{font-weight:900;font-size:11px;letter-spacing:.12em}.s18-promo h3{font-size:25px;line-height:1.05;margin:8px 0}.s18-promo p{font-size:12px;color:#626262;margin:0}.s18-category-section{padding:22px 0 12px}.s18-section-head{display:flex;justify-content:space-between;align-items:end;margin-bottom:18px}.s18-section-head h2{font-size:28px;letter-spacing:-1px;margin:0}.s18-section-head p{margin:5px 0 0;color:var(--muted);font-size:13px}.s18-categories{display:grid;grid-template-columns:repeat(6,1fr);gap:12px}.s18-categories button{border:0;background:#fafafa;border-radius:20px;min-height:100px;padding:15px 8px;font-weight:800;cursor:pointer;transition:.2s}.s18-categories button:hover{background:var(--soft);transform:translateY(-2px)}.s18-categories .ico{display:block;font-size:26px;margin-bottom:8px}.s18-trust{margin:28px auto;border-top:1px solid var(--line);border-bottom:1px solid var(--line);display:grid;grid-template-columns:repeat(4,1fr)}.s18-trust div{padding:20px 18px}.s18-trust b{display:block;font-size:13px}.s18-trust span{font-size:11px;color:#888;display:block;margin-top:4px}.s18-products{padding:25px 0 48px}.s18-products .com-toolbar{padding:0 0 14px;border:0;background:transparent}.s18-products .com-toolbar select{border:1px solid var(--line);background:#fff;border-radius:999px;padding:9px 13px}.s18-pills{display:flex;gap:8px;overflow:auto;scrollbar-width:none;margin:18px 0}.s18-pills .com-cat{border:1px solid var(--line);background:#fff;border-radius:999px;padding:9px 15px;white-space:nowrap;font-weight:750}.s18-pills .com-cat.active{background:var(--ink);border-color:var(--ink);color:#fff}.shop18 .com-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:18px}.shop18 .com-card{border:0;border-radius:20px;background:#fff;overflow:hidden;box-shadow:none}.shop18 .com-card-img{background:#f7f7f7;border-radius:20px;padding:12px}.shop18 .com-card-img img{border-radius:14px}.shop18 .com-card-body{padding:12px 4px 8px}.shop18 .com-card-body>small:not(.com-badge){color:#999}.shop18 .com-badge{background:var(--accent);color:#fff;border-radius:999px;padding:4px 8px}.shop18 .com-card-body h3{font-size:14px}.shop18 .com-card-price b{font-size:18px;color:var(--ink)}.shop18 .com-card-actions a{background:#f4f4f4;color:#222}.shop18 .com-card-actions button{background:var(--ink);color:#fff;border-radius:999px}.shop18 .com-pagination button.active{background:var(--accent);border-color:var(--accent)}.s18-newsletter{background:#f3f0ea;border-radius:30px;padding:36px;display:flex;justify-content:space-between;align-items:center;gap:25px}.s18-newsletter h2{font-size:28px;margin:0 0 5px}.s18-newsletter p{color:#6d6d6d;margin:0}.s18-newsletter a{background:var(--accent);color:#fff;text-decoration:none;font-weight:850;border-radius:999px;padding:13px 20px;white-space:nowrap}.s18-footer{margin-top:50px;background:#171717;color:#fff;padding:48px 0 24px}.s18-footgrid{display:grid;grid-template-columns:1.5fr repeat(3,1fr);gap:40px}.s18-footer h4{margin:0 0 13px}.s18-footer p,.s18-footer a{display:block;color:#aaa;text-decoration:none;font-size:12px;line-height:1.9}.s18-copy{border-top:1px solid #333;margin-top:30px;padding-top:18px;color:#777;font-size:11px}.shop18 .com-cart{z-index:100}
@media(max-width:900px){.s18-headrow{grid-template-columns:1fr auto;height:auto;padding:14px 0}.s18-search{grid-column:1/-1;grid-row:2}.s18-actions .admin{display:none}.s18-hero-grid{grid-template-columns:1fr}.s18-promos{grid-template-columns:1fr 1fr}.s18-hero-main{min-height:360px}.s18-categories{grid-template-columns:repeat(3,1fr)}.shop18 .com-grid{grid-template-columns:repeat(3,1fr)}}
@media(max-width:640px){.s18-wrap{width:calc(100% - 20px)}.s18-ann{font-size:10px}.s18-headrow{gap:8px}.s18-brand{font-size:21px}.s18-actions a{display:none}.s18-actions button{height:38px;padding:0 11px;font-size:11px}.s18-search{height:42px}.s18-search button{padding:0 15px}.s18-nav .s18-wrap{height:40px;gap:18px}.s18-hero{padding-top:10px}.s18-hero-main{padding:25px 20px;min-height:420px;grid-template-columns:1fr}.s18-hero-main h1{font-size:34px;letter-spacing:-1.5px}.s18-hero-main img{height:180px;order:-1}.s18-promos{display:none}.s18-section-head h2{font-size:22px}.s18-categories{display:flex;overflow:auto;scrollbar-width:none}.s18-categories button{flex:0 0 110px;min-height:85px}.s18-trust{grid-template-columns:1fr 1fr;margin-top:18px}.s18-trust div{padding:13px 8px}.shop18 .com-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.shop18 .com-card-body{padding:8px 2px}.shop18 .com-card-body h3{font-size:12px}.shop18 .com-card-price b{font-size:14px}.shop18 .com-card-actions>*{font-size:10px;padding:8px 3px}.s18-newsletter{padding:24px;display:block}.s18-newsletter h2{font-size:22px}.s18-newsletter a{display:inline-flex;margin-top:16px}.s18-footgrid{grid-template-columns:1fr 1fr;gap:24px}.s18-footgrid>div:first-child{grid-column:1/-1}}
`;document.head.appendChild(st)}

async function renderCommerceStore(site={}){comEnsureMobileCss();comEnsureV17Css();const root=document.querySelector('main');if(!root)return;document.querySelectorAll('footer.footer,footer.public-footer').forEach(x=>x.remove());const settings=sxSettings(site),brand=esc(settings.store_name||site.name||'Mộc Store'),hero=settings.hero_image||'/assets/marketing-demo.webp',admin=sxAdminNewPostUrl('dich-vu-5').replace('tab=newpost','tab=commerce-products');root.innerHTML=`<div class="shop18"><div class="s18-ann">FREESHIP THEO CHÍNH SÁCH · ĐỔI TRẢ RÕ RÀNG · HỖ TRỢ NHANH</div><header class="s18-head"><div class="s18-wrap s18-headrow"><a class="s18-brand" href="#">${brand}<em>+</em></a><div class="s18-search"><input id="comSearch" placeholder="Tìm sản phẩm, danh mục..."><button onclick="comFilter()">Tìm</button></div><div class="s18-actions"><a class="admin" href="${admin}" target="_blank">Quản trị</a><button class="bag" onclick="document.getElementById('comCart').classList.add('open')">Túi hàng · <span id="comCartCount">0</span></button></div></div><nav class="s18-nav"><div class="s18-wrap"><a class="hot" href="#products">Mới & nổi bật</a><a href="#categories">Danh mục</a><a href="#products">Sản phẩm</a><a href="#products">Bán chạy</a><a href="#support">Giao hàng & đổi trả</a></div></nav></header><section class="s18-hero"><div class="s18-wrap s18-hero-grid"><article class="s18-hero-main"><div><span class="s18-kicker">BỘ SƯU TẬP MỚI</span><h1>${esc(settings.hero_title||'Chọn món bạn thích. Mua theo cách của bạn.')}</h1><p>${esc(settings.hero_description||'Một không gian mua sắm gọn gàng, hiện đại với những sản phẩm được chọn lọc cho nhu cầu mỗi ngày.')}</p><a class="s18-cta" href="#products">Khám phá ngay →</a></div><img src="${esc(hero)}" alt="${brand}"></article><aside class="s18-promos"><article class="s18-promo"><small>HÀNG MỚI VỀ</small><h3>Fresh picks<br>for you.</h3><p>Cập nhật sản phẩm mới mỗi ngày.</p></article><article class="s18-promo"><small>SHOP SMARTER</small><h3>Giá tốt.<br>Mua dễ.</h3><p>Thông tin rõ ràng, đặt hàng nhanh.</p></article></aside></div></section><section class="s18-category-section" id="categories"><div class="s18-wrap"><div class="s18-section-head"><div><h2>Mua sắm theo danh mục</h2><p>Tìm nhanh đúng thứ bạn đang cần.</p></div></div><div id="s18CategoryMenu" class="s18-categories"><span>Đang tải danh mục...</span></div></div></section><section class="s18-wrap s18-trust" id="support"><div><b>🚚 Giao hàng linh hoạt</b><span>Nhiều phương thức vận chuyển</span></div><div><b>↩ Đổi trả rõ ràng</b><span>Chính sách minh bạch</span></div><div><b>🔒 Thanh toán an toàn</b><span>COD · Chuyển khoản · VietQR</span></div><div><b>💬 Hỗ trợ nhanh</b><span>Tư vấn trước và sau mua</span></div></section><section class="s18-products" id="products"><div class="s18-wrap"><div class="s18-section-head"><div><h2>Sản phẩm dành cho bạn</h2><p>Những lựa chọn nổi bật từ cửa hàng.</p></div></div><div id="comCats" class="s18-pills"></div><div class="com-toolbar"><div><b id="comResultCount">0 sản phẩm</b></div><select id="comSort" onchange="comFilter()"><option value="featured">Đề xuất</option><option value="newest">Mới nhất</option><option value="price_asc">Giá thấp → cao</option><option value="price_desc">Giá cao → thấp</option></select></div><div id="comGrid" class="com-grid"><p>Đang tải sản phẩm...</p></div></div></section><section class="s18-wrap"><div class="s18-newsletter"><div><h2>Tìm thấy món đồ dành cho bạn.</h2><p>Duyệt toàn bộ danh mục hoặc tìm kiếm sản phẩm ngay phía trên.</p></div><a href="#products">Xem tất cả sản phẩm</a></div></section><footer class="s18-footer"><div class="s18-wrap"><div class="s18-footgrid"><div><h4>${brand}</h4><p>${esc(settings.footer_intro||'Cửa hàng trực tuyến hiện đại, mua sắm nhanh và thuận tiện trên mọi thiết bị.')}</p></div><div><h4>Mua sắm</h4><a href="#products">Sản phẩm</a><a href="#categories">Danh mục</a></div><div><h4>Hỗ trợ</h4><a href="#support">Giao hàng</a><a href="#support">Đổi trả</a><a href="#support">Thanh toán</a></div><div><h4>Liên hệ</h4><p>${esc(site.phone||'Hotline đang cập nhật')}</p><p>${esc(site.email||'Email đang cập nhật')}</p></div></div><div class="s18-copy">© 2026 ${brand}. All rights reserved.</div></div></footer></div><aside class="com-cart" id="comCart"><div class="com-cart-head"><b>Giỏ hàng</b><button onclick="document.getElementById('comCart').classList.remove('open')">✕</button></div><div class="com-cart-list" id="comCartList"></div><div class="com-cart-foot"><div class="com-order-summary"><p>Tạm tính <b id="comCartTotal">0đ</b></p></div><form class="com-checkout" onsubmit="comCheckout(event)"><h3>Thông tin nhận hàng</h3><input name="customer_name" required placeholder="Họ và tên *"><input name="phone" required placeholder="Số điện thoại *"><input name="email" type="email" placeholder="Email"><div class="com-address-grid"><input name="province" required placeholder="Tỉnh / Thành phố *"><input name="district" required placeholder="Quận / Huyện *"><input name="ward" required placeholder="Phường / Xã *"></div><input name="address" required placeholder="Số nhà, tên đường *"><h3>Vận chuyển</h3><label><input type="radio" name="shipping_method" value="standard" checked> Giao hàng tiêu chuẩn</label><label><input type="radio" name="shipping_method" value="express"> Giao nhanh</label><h3>Thanh toán</h3><div class="com-payment-options" id="comPaymentOptions"></div><textarea name="note" placeholder="Ghi chú đơn hàng"></textarea><button type="submit">Xác nhận đặt hàng</button><div id="comCheckoutMsg"></div></form></div></aside>`;try{const r=await fetch(comApi('catalog')),d=await r.json();if(!r.ok)throw new Error(d.error||'Không tải được sản phẩm');COM_DATA=d;const detailSlug=decodeURIComponent((location.pathname.match(/\/san-pham\/([^/]+)/)||[])[1]||'');if(detailSlug){const dp=d.products.find(x=>String(x.slug)===detailSlug||String(x.id)===detailSlug);if(dp){comRenderProductDetail(dp);return}}const cats=d.categories||[];document.getElementById('comCats').innerHTML=`<button class="com-cat active" data-slug="">Tất cả</button>`+cats.map(c=>`<button class="com-cat" data-slug="${esc(c.slug)}">${esc(c.name)}</button>`).join('');const icons=['✦','◉','◇','♡','⌂','□','⌁','◎','＋'];const menu=document.getElementById('s18CategoryMenu');menu.innerHTML=cats.length?cats.slice(0,9).map((c,i)=>`<button type="button" data-menu-cat="${esc(c.slug)}"><span class="ico">${icons[i%icons.length]}</span>${esc(c.name)}</button>`).join(''):'<span>Chưa có danh mục</span>';document.querySelectorAll('.com-cat').forEach(b=>b.onclick=()=>{document.querySelectorAll('.com-cat').forEach(x=>x.classList.remove('active'));b.classList.add('active');comFilter()});menu.querySelectorAll('[data-menu-cat]').forEach(b=>b.onclick=()=>{document.querySelector(`.com-cat[data-slug="${CSS.escape(b.dataset.menuCat)}"]`)?.click();document.getElementById('products')?.scrollIntoView({behavior:'smooth'})});const ps=[];if(Number(d.settings.cod_enabled??1))ps.push('<label><input type="radio" name="payment_method" value="cod" checked> Thanh toán khi nhận hàng (COD)</label>');if(Number(d.settings.bank_enabled??1))ps.push('<label><input type="radio" name="payment_method" value="bank"> Chuyển khoản / VietQR</label>');if(Number(d.settings.store_pickup_enabled))ps.push('<label><input type="radio" name="payment_method" value="pickup"> Thanh toán tại cửa hàng</label>');if(Number(d.settings.online_enabled))ps.push('<label><input type="radio" name="payment_method" value="online"> Thanh toán online</label>');document.getElementById('comPaymentOptions').innerHTML=ps.join('');document.getElementById('comSearch').oninput=comFilter;comFilter();comCartRender()}catch(e){document.getElementById('comGrid').innerHTML='<p>'+esc(e.message)+'</p>'}}
