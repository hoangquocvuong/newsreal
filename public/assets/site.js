...
function renderShowcaseTemplate(preset,site={}){
 ...
 const featured=all[0],heroImg=String(settings.hero_image_url||(featured?(getImages(featured)[0]||featured.image||''):'')),heroTitle=String(settings.hero_title||site.name||c[0]),heroPrimary=String(settings.hero_primary_label||'Xem nội dung'),heroPrimaryUrl=String(settings.hero_primary_url||'#noi-dung'),heroSecondary=String(settings.hero_secondary_label||'Liên hệ'),heroSecondaryUrl=String(settings.hero_secondary_url||'#contact');
