...
async function renderCommerceStore(site={}){
 ...
 const raw=Array.isArray(SITE_DATA?.commerce_products)?SITE_DATA.commerce_products:[];
 ...
 const cats=['Tất cả',...new Set(products.map(x=>x.cat).filter(Boolean))],PAGE=8,CART='nr-commerce-v24-cart',WISH='nr-commerce-v24-wish';
