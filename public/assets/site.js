...
/* V20.9.26.0 — Professional templates: tenant data + exact categories + contact workflow. */
...
function sxProfile(site={},key=''){let st=site.structure_profile;if(typeof st==='string'){try{st=JSON.parse(st)}catch(e){st={}}}const fallback={
 ...
 'doanh-nghiep-1':['Chuyển đổi số','Vận hành','Dữ liệu & phân tích','Khách hàng','Nhân sự','Tin doanh nghiệp'],
 'doanh-nghiep-2':['Sản xuất','Cơ khí & CNC','Quản lý chất lượng','An toàn lao động','Dự án','Bảo trì'],
...
function renderShowcaseTemplate(preset,site={}){
 ...
 const map={personal_blog_1:['blog-ca-nhan-1','blog','NHẬT KÝ CÁ NHÂN','Bài viết, trải nghiệm và góc nhìn được sắp xếp rõ ràng theo từng chuyên mục.','Đọc bài mới','violet'],personal_blog_2:['blog-ca-nhan-2','creator','GÓC NGƯỜI SÁNG TẠO','Không gian dành cho nội dung, dự án và hành trình xây dựng thương hiệu cá nhân.','Khám phá nội dung','orange'],corporate_modern_1:['doanh-nghiep-1','corp','DOANH NGHIỆP HIỆN ĐẠI','Giới thiệu năng lực, giải pháp, dự án và tin doanh nghiệp trong một hệ thống nội dung rõ ràng.','Nhận tư vấn','blue'],corporate_industry_2:['doanh-nghiep-2','industry','DOANH NGHIỆP CÔNG NGHIỆP','Năng lực sản xuất, kỹ thuật, dự án và chuyên san được tổ chức theo đúng chuyên mục.','Nhận báo giá','slate'],service_ev_charge_5:['dich-vu-5','ev','ĐIỂM SẠC XE ĐIỆN','Dịch vụ điểm sạc, lắp đặt, kỹ thuật và thư viện kiến thức xe điện.','Đăng ký khảo sát','cyan']};
