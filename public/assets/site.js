...
function comEnsureV17Css(){if(document.getElementById('com-v17-css'))return;const st=document.createElement('style');st.id='com-v17-css';st.textContent=`
body:has(.market17){background:#f6f7fb}.market17{font-family:Inter,system-ui,-apple-system,Segoe UI,sans-serif;color:#18202a;background:#f6f7fb;min-height:100vh}.market17 *{box-sizing:border-box}.market17 .m17-wrap{width:min(1180px,calc(100% - 32px));margin:auto}.m17-top{background:#111827;color:#dbe2ec;font-size:12px}.m17-top .m17-wrap{height:34px;display:flex;align-items:center;justify-content:space-between;gap:18px}.m17-top nav{display:flex;gap:18px}.m17-top a{color:inherit;text-decoration:none}.m17-head{background:#fff;border-bottom:1px solid #e8ebf0;position:sticky;top:0;z-index:35}.m17-head-row{min-height:76px;display:grid;grid-template-columns:190px minmax(280px,1fr) auto;gap:24px;align-items:center}.m17-logo{font-size:24px;font-weight:950;letter-spacing:-1px;color:#111827;text-decoration:none}.m17-logo i{font-style:normal;color:#ef4444}.m17-search{height:46px;border:2px solid #e5e7eb;border-radius:14px;display:flex;overflow:hidden;background:#f9fafb}.m17-search input{border:0;background:transparent;outline:0;flex:1;padding:0 16px;font-size:14px}.m17-search button{border:0;background:#111827;color:#fff;padding:0 22px;font-weight:800;cursor:pointer}.m17-actions{display:flex;gap:10px}.m17-actions a,.m17-actions button{height:42px;border:1px solid #e5e7eb;background:#fff;border-radius:12px;padding:0 14px;display:flex;align-items:center;gap:7px;text-decoration:none;color:#111827;font-weight:800;cursor:pointer}.m17-actions .cart{background:#ef4444;color:#fff;border-color:#ef4444}.m17-nav{background:#fff}.m17-nav .m17-wrap{height:48px;display:flex;align-items:center;gap:24px;overflow:auto;scrollbar-width:none}.m17-nav a{white-space:nowrap;text-decoration:none;color:#4b5563;font-size:13px;font-weight:750}.m17-nav a:first-child{color:#ef4444}.m17-hero{padding:22px 0 10px}.m17-hero-grid{display:grid;grid-template-columns:230px minmax(0,1fr) 260px;gap:16px}.m17-category-box,.m17-side-card,.m17-main-banner{background:#fff;border-radius:18px;overflow:hidden;border:1px solid #e8ebf0}.m17-category-box{padding:10px}.m17-category-box h3{font-size:14px;margin:4px 8px 8px}.m17-category-list{display:grid}.m17-category-list button{border:0;background:transparent;text-align:left;padding:9px 10px;border-radius:9px;color:#374151;cursor:pointer;font-size:13px}.m17-category-list button:hover{background:#f3f4f6;color:#ef4444}.m17-main-banner{min-height:330px;padding:38px;display:grid;grid-template-columns:1.05fr .95fr;align-items:center;background:linear-gradient(120deg,#fff1f2 0,#fff 58%,#fef3c7 100%);position:relative}.m17-main-banner small{font-weight:900;color:#ef4444;letter-spacing:.12em}.m17-main-banner h1{font-size:42px;line-height:1.03;letter-spacing:-1.8px;margin:12px 0;color:#111827}.m17-main-banner p{color:#6b7280;line-height:1.65;margin:0 0 20px}.m17-main-banner .cta{display:inline-flex;background:#111827;color:#fff;padding:12px 18px;border-radius:11px;text-decoration:none;font-weight:850}.m17-main-banner img{width:100%;height:260px;object-fit:contain;filter:drop-shadow(0 18px 25px rgba(17,24,39,.14))}.m17-side{display:grid;gap:16px}.m17-side-card{padding:20px;min-height:157px;background:linear-gradient(135deg,#ecfeff,#fff)}.m17-side-card:last-child{background:linear-gradient(135deg,#fef3c7,#fff7ed)}.m17-side-card small{font-weight:900;color:#0891b2}.m17-side-card h3{margin:8px 0 5px;font-size:20px}.m17-side-card p{font-size:13px;color:#6b7280;margin:0}.m17-benefits{padding:14px 0 24px}.m17-benefit-grid{background:#fff;border:1px solid #e8ebf0;border-radius:16px;display:grid;grid-template-columns:repeat(4,1fr)}.m17-benefit-grid div{padding:17px 20px;border-right:1px solid #edf0f4}.m17-benefit-grid div:last-child{border:0}.m17-benefit-grid b{display:block;font-size:13px}.m17-benefit-grid span{display:block;color:#8a94a3;font-size:11px;margin-top:3px}.m17-section{padding:16px 0 34px}.m17-title{display:flex;align-items:end;justify-content:space-between;margin-bottom:16px}.m17-title h2{font-size:26px;margin:0;letter-spacing:-.7px}.m17-title p{margin:5px 0 0;color:#7b8492;font-size:13px}.m17-title a{color:#ef4444;text-decoration:none;font-weight:800;font-size:13px}.m17-cat-pills{display:flex;gap:9px;overflow:auto;padding-bottom:4px;scrollbar-width:none;margin-bottom:16px}.m17-cat-pills .com-cat{border:1px solid #e2e6ec;background:#fff;color:#4b5563;border-radius:999px;padding:9px 14px;white-space:nowrap;font-weight:750}.m17-cat-pills .com-cat.active{background:#111827;color:#fff;border-color:#111827}.market17 .com-toolbar{background:transparent;border:0;padding:0 0 14px}.market17 .com-toolbar b{font-size:14px}.market17 .com-toolbar select{border:1px solid #e1e5eb;border-radius:10px;padding:9px 12px;background:#fff}.market17 .com-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.market17 .com-card{border:1px solid #e7eaf0;border-radius:16px;background:#fff;box-shadow:none;overflow:hidden}.market17 .com-card:hover{transform:translateY(-3px);box-shadow:0 12px 28px rgba(17,24,39,.08)}.market17 .com-card-img{background:#f8f9fb;padding:10px}.market17 .com-card-img img{border-radius:11px}.market17 .com-card-body{padding:13px}.market17 .com-card-body>small:not(.com-badge){color:#9ca3af;font-size:10px;text-transform:uppercase;font-weight:800}.market17 .com-badge{background:#fee2e2;color:#dc2626;border-radius:6px;padding:4px 7px;font-weight:900}.market17 .com-card-body h3{font-size:14px;min-height:36px}.market17 .com-card-body p{font-size:11px;color:#7b8492;min-height:31px}.market17 .com-card-price b{font-size:17px;color:#ef4444}.market17 .com-card-actions a{background:#f3f4f6;color:#374151}.market17 .com-card-actions button{background:#111827}.m17-discovery{background:#111827;color:#fff;border-radius:20px;padding:26px 28px;display:grid;grid-template-columns:1fr 1.5fr;align-items:center;gap:20px}.m17-discovery h2{margin:0 0 6px}.m17-discovery p{margin:0;color:#aab3c2}.m17-discovery .com-discovery-links{margin:0;justify-content:flex-end}.m17-discovery .com-discovery-links button{background:#fff;color:#111827}.m17-footer{margin-top:28px;background:#fff;border-top:1px solid #e5e7eb;padding:38px 0 22px}.m17-footer-grid{display:grid;grid-template-columns:1.4fr repeat(3,1fr);gap:35px}.m17-footer h4{margin:0 0 12px}.m17-footer p,.m17-footer a{font-size:12px;color:#6b7280;line-height:1.8;text-decoration:none;display:block}.m17-copy{border-top:1px solid #edf0f4;margin-top:28px;padding-top:18px;color:#9ca3af;font-size:11px}.market17 .com-pagination button.active{background:#ef4444;border-color:#ef4444}.market17 .com-cart{z-index:100}
@media(max-width:900px){.m17-head-row{grid-template-columns:1fr auto}.m17-search{grid-column:1/-1;grid-row:2;margin-bottom:12px}.m17-actions .admin{display:none}.m17-hero-grid{grid-template-columns:1fr}.m17-category-box{display:none}.m17-side{grid-template-columns:1fr 1fr}.m17-main-banner{min-height:280px}.m17-benefit-grid{grid-template-columns:1fr 1fr}.m17-benefit-grid div:nth-child(2){border-right:0}.market17 .com-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}
@media(max-width:640px){.market17 .m17-wrap{width:min(100% - 20px,1180px)}.m17-top{display:none}.m17-head-row{min-height:60px;gap:8px}.m17-logo{font-size:20px}.m17-actions a{display:none}.m17-actions button{height:38px;padding:0 10px;font-size:12px}.m17-search{height:42px}.m17-nav .m17-wrap{height:42px;gap:18px}.m17-hero{padding-top:10px}.m17-main-banner{padding:24px 20px;grid-template-columns:1fr;min-height:330px}.m17-main-banner h1{font-size:30px}.m17-main-banner img{height:150px;order:-1}.m17-side{display:none}.m17-benefit-grid{grid-template-columns:1fr 1fr}.m17-benefit-grid div{padding:12px}.m17-benefit-grid b{font-size:11px}.m17-benefit-grid span{font-size:9px}.m17-title h2{font-size:21px}.market17 .com-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.market17 .com-card-body{padding:9px}.market17 .com-card-body h3{font-size:12px}.market17 .com-card-price b{font-size:14px}.market17 .com-card-actions>*{font-size:10px;padding:8px 3px}.m17-discovery{grid-template-columns:1fr;padding:20px}.m17-discovery .com-discovery-links{justify-content:flex-start}.m17-footer-grid{grid-template-columns:1fr 1fr;gap:22px}.m17-footer-grid>div:first-child{grid-column:1/-1}}
`;document.head.appendChild(st)}

async function renderCommerceStore(site={}){comEnsureMobileCss();comEnsureV17Css();const root=document.querySelector('main');if(!root)return;document.querySelectorAll('footer.footer,footer.public-footer').forEach(x=>x.remove());const settings=sxSettings(site),brand=esc(settings.store_name||site.name||'NOVA MARKET'),hero=settings.hero_image||'/assets/marketing-demo.webp',admin=sxAdminNewPostUrl('dich-vu-5').replace('tab=newpost','tab=commerce-products');root.innerHTML=`<div class="market17"><div class="m17-top"><div class="m17-wrap"><span>Miễn phí vận chuyển theo chính sách cửa hàng</span><nav><a href="#">Theo dõi đơn hàng</a><a href="#">Trợ giúp</a><a href="${admin}" target="_blank">Quản trị shop</a></nav></div></div><header class="m17-head"><div class="m17-wrap m17-head-row"><a class="m17-logo" href="#">${brand}<i>.</i></a><div class="m17-search"><input id="comSearch" placeholder="Bạn đang tìm sản phẩm gì?"><button onclick="comFilter()">Tìm kiếm</button></div><div class="m17-actions"><a class="admin" href="${admin}" target="_blank">Quản trị</a><button class="cart" onclick="document.getElementById('comCart').classList.add('open')">🛒 <span>Giỏ hàng</span> (<span id="comCartCount">0</span>)</button></div></div><nav class="m17-nav"><div class="m17-wrap"><a href="#products">Tất cả sản phẩm</a><a href="#featured">Nổi bật</a><a href="#products">Hàng mới</a><a href="#products">Bán chạy</a><a href="#discover">Danh mục</a><a href="#footer">Chính sách</a></div></nav></header><section class="m17-hero" id="featured"><div class="m17-wrap m17-hero-grid"><aside class="m17-category-box"><h3>☰ Danh mục mua sắm</h3><div id="m17CategoryMenu" class="m17-category-list"><span style="padding:10px;color:#9ca3af">Đang tải danh mục...</span></div></aside><div class="m17-main-banner"><div><small>MUA SẮM THÔNG MINH</small><h1>${esc(settings.hero_title||'Sản phẩm tốt. Giá hợp lý. Mua sắm dễ dàng.')}</h1><p>${esc(settings.hero_description||'Khám phá sản phẩm nổi bật, hàng mới và những lựa chọn phù hợp cho nhu cầu hằng ngày.')}</p><a class="cta" href="#products">Mua sắm ngay →</a></div><img src="${esc(hero)}" alt="${brand}"></div><div class="m17-side"><article class="m17-side-card"><small>HÀNG MỚI</small><h3>Khám phá sản phẩm mới</h3><p>Cập nhật nhanh những sản phẩm vừa lên kệ.</p></article><article class="m17-side-card"><small>ƯU ĐÃI NỔI BẬT</small><h3>Mua dễ hơn mỗi ngày</h3><p>Giá rõ ràng, thanh toán linh hoạt và hỗ trợ nhanh.</p></article></div></div></section><section class="m17-benefits"><div class="m17-wrap m17-benefit-grid"><div><b>🚚 Giao hàng linh hoạt</b><span>Nhiều lựa chọn vận chuyển</span></div><div><b>↩ Đổi trả rõ ràng</b><span>Chính sách minh bạch</span></div><div><b>🔒 Thanh toán an toàn</b><span>COD · Chuyển khoản · VietQR</span></div><div><b>💬 Hỗ trợ nhanh</b><span>Tư vấn trước và sau mua</span></div></div></section><main class="m17-section" id="products"><div class="m17-wrap"><div class="m17-title"><div><h2>Sản phẩm dành cho bạn</h2><p>Khám phá các lựa chọn nổi bật từ cửa hàng</p></div><a href="#discover">Xem danh mục →</a></div><div id="comCats" class="m17-cat-pills"></div><div class="com-toolbar"><div><b id="comResultCount">0 sản phẩm</b></div><select id="comSort" onchange="comFilter()"><option value="featured">Đề xuất</option><option value="newest">Mới nhất</option><option value="price_asc">Giá thấp → cao</option><option value="price_desc">Giá cao → thấp</option></select></div><div id="comGrid" class="com-grid"><p>Đang tải sản phẩm...</p></div></div></main><section class="m17-section" id="discover"><div class="m17-wrap"><div class="m17-discovery"><div><h2>Mua sắm theo danh mục</h2><p>Đi thẳng tới nhóm sản phẩm bạn đang quan tâm.</p></div><div id="comDiscoveryLinks" class="com-discovery-links"></div></div></div></section><footer class="m17-footer" id="footer"><div class="m17-wrap"><div class="m17-footer-grid"><div><h4>${brand}</h4><p>${esc(settings.footer_intro||'Cửa hàng trực tuyến hiện đại, tập trung vào trải nghiệm mua sắm nhanh, rõ ràng và thuận tiện trên mọi thiết bị.')}</p></div><div><h4>Mua sắm</h4><a href="#products">Sản phẩm</a><a href="#discover">Danh mục</a><a href="#featured">Nổi bật</a></div><div><h4>Hỗ trợ</h4><a href="#footer">Giao hàng</a><a href="#footer">Đổi trả</a><a href="#footer">Thanh toán</a></div><div><h4>Liên hệ</h4><p>${esc(site.phone||'Hotline đang cập nhật')}</p><p>${esc(site.email||'Email đang cập nhật')}</p></div></div><div class="m17-copy">© 2026 ${brand}. Website bán hàng trực tuyến.</div></div></footer></div><aside class="com-cart" id="comCart"><div class="com-cart-head"><b>Giỏ hàng</b><button onclick="document.getElementById('comCart').classList.remove('open')">✕</button></div><div class="com-cart-list" id="comCartList"></div><div class="com-cart-foot"><div class="com-order-summary"><p>Tạm tính <b id="comCartTotal">0đ</b></p></div><form class="com-checkout" onsubmit="comCheckout(event)"><h3>Thông tin nhận hàng</h3><input name="customer_name" required placeholder="Họ và tên *"><input name="phone" required placeholder="Số điện thoại *"><input name="email" type="email" placeholder="Email"><div class="com-address-grid"><input name="province" required placeholder="Tỉnh / Thành phố *"><input name="district" required placeholder="Quận / Huyện *"><input name="ward" required placeholder="Phường / Xã *"></div><input name="address" required placeholder="Số nhà, tên đường *"><h3>Vận chuyển</h3><label><input type="radio" name="shipping_method" value="standard" checked> Giao hàng tiêu chuẩn</label><label><input type="radio" name="shipping_method" value="express"> Giao nhanh</label><h3>Thanh toán</h3><div class="com-payment-options" id="comPaymentOptions"></div><textarea name="note" placeholder="Ghi chú đơn hàng"></textarea><button type="submit">Xác nhận đặt hàng</button><div id="comCheckoutMsg"></div></form></div></aside>`;try{const r=await fetch(comApi('catalog')),d=await r.json();if(!r.ok)throw new Error(d.error||'Không tải được sản phẩm');COM_DATA=d;const detailSlug=decodeURIComponent((location.pathname.match(/\/san-pham\/([^/]+)/)||[])[1]||'');if(detailSlug){const dp=d.products.find(x=>String(x.slug)===detailSlug||String(x.id)===detailSlug);if(dp){comRenderProductDetail(dp);return}}const cats=d.categories||[];document.getElementById('comCats').innerHTML=`<button class="com-cat active" data-slug="">Tất cả</button>`+cats.map(c=>`<button class="com-cat" data-slug="${esc(c.slug)}">${esc(c.name)}</button>`).join('');const menu=document.getElementById('m17CategoryMenu');menu.innerHTML=cats.length?cats.slice(0,9).map(c=>`<button type="button" data-menu-cat="${esc(c.slug)}">${esc(c.name)} <span style="float:right">›</span></button>`).join(''):'<span style="padding:10px;color:#9ca3af">Chưa có danh mục</span>';document.querySelectorAll('.com-cat').forEach(b=>b.onclick=()=>{document.querySelectorAll('.com-cat').forEach(x=>x.classList.remove('active'));b.classList.add('active');comFilter()});menu.querySelectorAll('[data-menu-cat]').forEach(b=>b.onclick=()=>{document.querySelector(`.com-cat[data-slug="${CSS.escape(b.dataset.menuCat)}"]`)?.click();document.getElementById('products')?.scrollIntoView({behavior:'smooth'})});const dl=document.getElementById('comDiscoveryLinks');dl.innerHTML=cats.slice(0,8).map(c=>`<button type="button" data-discovery="${esc(c.slug)}">${esc(c.name)}</button>`).join('');dl.querySelectorAll('[data-discovery]').forEach(b=>b.onclick=()=>{document.querySelector(`.com-cat[data-slug="${CSS.escape(b.dataset.discovery)}"]`)?.click();document.getElementById('products')?.scrollIntoView({behavior:'smooth'})});const ps=[];if(Number(d.settings.cod_enabled??1))ps.push('<label><input type="radio" name="payment_method" value="cod" checked> Thanh toán khi nhận hàng (COD)</label>');if(Number(d.settings.bank_enabled??1))ps.push('<label><input type="radio" name="payment_method" value="bank"> Chuyển khoản / VietQR</label>');if(Number(d.settings.store_pickup_enabled))ps.push('<label><input type="radio" name="payment_method" value="pickup"> Thanh toán tại cửa hàng</label>');if(Number(d.settings.online_enabled))ps.push('<label><input type="radio" name="payment_method" value="online"> Thanh toán online</label>');document.getElementById('comPaymentOptions').innerHTML=ps.join('');document.getElementById('comSearch').oninput=comFilter;comFilter();comCartRender()}catch(e){document.getElementById('comGrid').innerHTML='<p>'+esc(e.message)+'</p>'}}
