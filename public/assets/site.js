...
function renderShowcaseTemplate(preset,site={}){
 ...
 const featured=all[0],heroImg=featured?(getImages(featured)[0]||featured.image):'/assets/marketing-demo.webp';
