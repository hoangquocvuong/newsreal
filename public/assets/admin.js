...
function setWebsiteSettingsEditing(editing){
 [setName,setPhone,setZalo,setEmail,setFacebook,setSeoTitle,setSeoDescription,setSeoOgImage,setSeoIndex].forEach(el=>{if(el)el.disabled=!editing});document.querySelectorAll('[data-template-setting],[data-template-image-file]').forEach(el=>el.disabled=!editing);
