...
function defaultTemplateStructure(key){
 const ssot=professionalTemplateContract(key);
 ...
 const proSettings=[{key:'footer_intro',label:'Giới thiệu ngắn ở Footer',type:'textarea',default:'Thông tin ngắn về doanh nghiệp hoặc thương hiệu.'},{key:'footer_address',label:'Địa chỉ hiển thị ở Footer',type:'text',default:''},{key:'footer_phone',label:'Hotline Footer',type:'text',default:''},{key:'footer_email',label:'Email Footer',type:'text',default:''},{key:'footer_facebook',label:'Facebook Footer',type:'url',default:''},{key:'footer_zalo',label:'Zalo Footer',type:'text',default:''},{key:'privacy_url',label:'Link Chính sách bảo mật',type:'url',default:'#'},{key:'terms_url',label:'Link Điều khoản sử dụng',type:'url',default:'#'},{key:'footer_copyright',label:'Dòng bản quyền',type:'text',default:'© 2026. Bản quyền thuộc doanh nghiệp.'},{key:'contact_title',label:'Tiêu đề khối liên hệ',type:'text',default:'Liên hệ với chúng tôi'},{key:'contact_intro',label:'Mô tả khối liên hệ',type:'textarea',default:'Để lại thông tin hoặc liên hệ trực tiếp để được hỗ trợ.'},{key:'contact_address',label:'Địa chỉ',type:'text',default:''},{key:'working_hours',label:'Giờ làm việc',type:'text',default:'Thứ 2 – Thứ 7 · 08:00 – 18:00'},{key:'map_url',label:'Link bản đồ',type:'url',placeholder:'https://maps.google.com/...'},{key:'contact_cta',label:'Nhãn nút gửi liên hệ',type:'text',default:'Gửi yêu cầu'},{key:'hero_note',label:'Mô tả Hero',type:'textarea',default:''},{key:'hero_title',label:'Tiêu đề Hero',type:'text',default:''},{key:'hero_image_url',label:'Ảnh Hero',type:'url',default:'',placeholder:'https://.../anh-hero.jpg',help:'Ảnh lớn đầu trang. Có thể để trống để dùng ảnh bài nổi bật nếu có.'},{key:'hero_primary_label',label:'Nhãn nút Hero chính',type:'text',default:'Xem nội dung'},{key:'hero_primary_url',label:'Link nút Hero chính',type:'text',default:'#noi-dung'},{key:'hero_secondary_label',label:'Nhãn nút Hero phụ',type:'text',default:'Liên hệ'},{key:'hero_secondary_url',label:'Link nút Hero phụ',type:'text',default:'#contact'}];
 const lionSettings=[
  {key:'hero_badge',label:'Dòng nhỏ trên Hero',type:'text',default:'LÂN SƯ RỒNG · BIỂU DIỄN SỰ KIỆN',help:'Hiển thị phía trên tiêu đề lớn của Hero.'},
  {key:'hero_title',label:'Tiêu đề Hero',type:'textarea',default:'Khai hội rộn ràng – Khởi đầu may mắn cùng Lân Sư Rồng chuyên nghiệp.'},
  {key:'hero_note',label:'Mô tả Hero',type:'textarea',default:'Nhận biểu diễn khai trương, động thổ, Trung Thu, Tết, lễ hội và sự kiện doanh nghiệp. Gói dịch vụ rõ nhân sự, nhạc cụ, đạo cụ và hạng mục đi kèm để khách dễ chọn.'},
  {key:'hero_image_url',label:'Ảnh Slider Hero 1',type:'url',default:'https://images.unsplash.com/photo-1675605849420-8637ece6a0a1?auto=format&fit=crop&w=1800&q=86',placeholder:'https://.../anh-hero-1.jpg',help:'Ảnh đầu tiên của slider Hero.'},
  {key:'hero_image_url_2',label:'Ảnh Slider Hero 2',type:'url',default:'https://images.unsplash.com/photo-1772374998724-a8d939b12acb?auto=format&fit=crop&w=1800&q=84',placeholder:'https://.../anh-hero-2.jpg',help:'Ảnh thứ hai của slider Hero.'},
  {key:'hero_image_url_3',label:'Ảnh Slider Hero 3',type:'url',default:'https://images.unsplash.com/photo-1758776935722-77bd8efa6339?auto=format&fit=crop&w=1800&q=84',placeholder:'https://.../anh-hero-3.jpg',help:'Ảnh thứ ba của slider Hero.'},
  {key:'hero_primary_label',label:'Nhãn nút Hero chính',type:'text',default:'Xem gói biểu diễn'},
  {key:'hero_primary_url',label:'Link nút Hero chính',type:'text',default:'#packages'},
  {key:'hero_secondary_label',label:'Nhãn nút Hero phụ',type:'text',default:'Liên hệ báo giá'},
  {key:'hero_secondary_url',label:'Link nút Hero phụ',type:'text',default:'#contact'},
  {key:'experience_years',label:'Hero · Ô số 1 — Kinh nghiệm',type:'text',default:'15+ năm biểu diễn'},
  {key:'event_count',label:'Hero · Ô số 2 — Sự kiện',type:'text',default:'800+ sự kiện'},
  {key:'member_count',label:'Hero · Ô số 3 — Thành viên',type:'text',default:'35+ thành viên'},
  {key:'hero_stat_4_value',label:'Hero · Ô số 4 — Giá trị',type:'text',default:'24/7'},
  {key:'hero_stat_4_label',label:'Hero · Ô số 4 — Nhãn',type:'text',default:'Nhận lịch sự kiện'},
  {key:'troupe_intro',label:'Giới thiệu về đoàn lân',type:'textarea',default:'Đoàn tập trung vào đội hình đẹp, nhịp trống chắc, tác phong đúng giờ và kịch bản phù hợp từng không gian. Mỗi chương trình đều có người phụ trách điều phối và kiểm tra an toàn trước khi biểu diễn.'},
  {key:'award_1',label:'Danh hiệu / thành tích 1',type:'text',default:'Giải Nhất Hội diễn Lân Sư Rồng cấp thành phố'},
  {key:'award_2',label:'Danh hiệu / thành tích 2',type:'text',default:'Top 3 Liên hoan Lân Sư Rồng mở rộng'},
  {key:'award_3',label:'Danh hiệu / thành tích 3',type:'text',default:'Đơn vị biểu diễn tiêu biểu tại nhiều sự kiện doanh nghiệp'},
  {key:'service_area_note',label:'Khu vực nhận biểu diễn',type:'text',default:'Hải Phòng và các tỉnh lân cận'},
  {key:'contact_title',label:'Tiêu đề khối liên hệ',type:'text',default:'Kết nối với HẢI PHÒNG LÂN ĐƯỜNG'},
  {key:'contact_intro',label:'Mô tả khối liên hệ',type:'textarea',default:'Trao đổi nhu cầu, nhận tư vấn và thông tin phù hợp. Hotline, email, Zalo và nội dung khối này đều có thể chỉnh trong Trang quản trị.'},
  {key:'contact_address',label:'Địa chỉ',type:'text',default:''},{key:'working_hours',label:'Giờ làm việc',type:'text',default:'24/7 theo lịch sự kiện'},{key:'map_url',label:'Link bản đồ',type:'url',placeholder:'https://maps.google.com/...'},{key:'contact_cta',label:'Nhãn nút gửi liên hệ',type:'text',default:'Gửi yêu cầu'},
  {key:'footer_intro',label:'Giới thiệu ngắn ở Footer',type:'textarea',default:'Dịch vụ Lân Sư Rồng cho khai trương, lễ hội, Trung Thu, Tết và sự kiện doanh nghiệp. Đội hình linh hoạt, kịch bản rõ ràng, nhận lịch theo khu vực.'},{key:'footer_address',label:'Địa chỉ hiển thị ở Footer',type:'text',default:''},{key:'footer_phone',label:'Hotline Footer',type:'text',default:''},{key:'footer_email',label:'Email Footer',type:'text',default:''},{key:'footer_facebook',label:'Facebook Footer',type:'url',default:''},{key:'footer_zalo',label:'Zalo Footer',type:'text',default:''},{key:'privacy_url',label:'Link Chính sách bảo mật',type:'url',default:'#'},{key:'terms_url',label:'Link Điều khoản sử dụng',type:'url',default:'#'},{key:'footer_copyright',label:'Dòng bản quyền',type:'text',default:'© 2026 HẢI PHÒNG LÂN ĐƯỜNG'}
 ];
 const evSettings=[...proSettings,{key:'ev_station_api_url',label:'API trạng thái điểm sạc',type:'url',default:'',placeholder:'https://api.example.com/stations',help:'Endpoint JSON do đơn vị vận hành trạm sạc cấp quyền. Để trống sẽ dùng dữ liệu mẫu; không nên dùng API không được phép.'},{key:'ev_station_api_note',label:'Ghi chú nguồn dữ liệu trạm sạc',type:'textarea',default:'Dữ liệu điểm sạc được cập nhật từ hệ thống vận hành được cấp quyền.'},{key:'ev_map_center',label:'Tâm bản đồ mặc định',type:'text',default:'20.8449,106.6881',help:'Tọa độ dạng vĩ độ,kinh độ. Ví dụ: 20.8449,106.6881'},{key:'ev_map_zoom',label:'Mức thu phóng bản đồ',type:'text',default:'12'}];
 const p={
...
,
  ...
  'dich-vu-5':{version:8,layout_contract:'universal-layout-v1',content_type:'service',geometry_locked:1,settings_schema:evSettings,lead_contract:'service-lead-v1',station_data_contract:'authorized-api-or-demo-v1',map_contract:'leaflet-osm-v1',sections:[sec('hero','section','Điểm sạc xe điện',{content_source:'none',bind_required:0}),sec('stations','section','Điểm sạc gần bạn',{content_source:'none',bind_required:0}),sec('services','services','Giải pháp sạc',{content_source:'none',bind_required:0}),cat(1,'Kiến thức sạc',{slots:6,desktop_columns:3}),cat(2,'Lắp đặt tại nhà',{slots:6,desktop_columns:3}),cat(3,'Điểm sạc công cộng',{slots:6,desktop_columns:3}),cat(4,'Kỹ thuật điện',{slots:6,desktop_columns:3}),cat(5,'Bảo trì',{slots:6,desktop_columns:3}),cat(6,'Vận hành đội xe',{slots:6,desktop_columns:3}),sec('contact','section','Đăng ký khảo sát',{content_source:'none',bind_required:0})]},
...
async function ensureTemplateCatalog(env){
  ...
  const seeds=[
    ...
    {key:'dich-vu-5',name:'Dịch vụ · Điểm sạc xe điện',category:'dich-vu',preset:'service_ev_charge_5',price:1599000,renewal:2099000,sort:5,image:'https://images.unsplash.com/photo-1755555707544-5f2cea7413c1?auto=format&fit=crop&w=1200&q=82',demo:'/demo/dich-vu/tram-sac-vinfast/',badge:'TRẠM SẠC EV',description:'Website dịch vụ cung cấp, lắp đặt và tra cứu điểm sạc xe điện VinFast.',features:'Điểm sạc & khu vực\nGói lắp đặt\nQuy trình khảo sát\nCTA tư vấn',accent:'cyan'},
  ...
  // V20.9.27.13 — SSOT V2: taxonomy/editor profile comes from the same template contract as layout.
  for(const key of PROFESSIONAL_TEMPLATE_KEYS){const ep=professionalEditorProfile(key);if(ep)professionalEditors[key]=ep}
