...
,
  ...
  'dich-vu-5':{version:9,layout_contract:'universal-layout-v1',content_type:'service',geometry_locked:1,settings_schema:laptopSettings,lead_contract:'service-lead-v1',route_contract:'service-commerce-v2',card_contract:'laptop-product-card-v1',article_contract:'service-detail-v2',sections:[sec('hero','section','Cửa hàng Laptop',{content_source:'none',bind_required:0}),sec('products','section','Laptop nổi bật',{content_source:'none',bind_required:0}),cat(1,'Laptop văn phòng',{slots:6,desktop_columns:3}),cat(2,'Laptop gaming',{slots:6,desktop_columns:3}),cat(3,'Laptop mỏng nhẹ',{slots:6,desktop_columns:3}),cat(4,'Laptop đồ họa',{slots:6,desktop_columns:3}),cat(5,'MacBook',{slots:6,desktop_columns:3}),cat(6,'Cẩm nang laptop',{slots:6,desktop_columns:3}),sec('contact','section','Nhận tư vấn chọn laptop',{content_source:'none',bind_required:0})]},
...
async function ensureTemplateCatalog(env){
  ...
  const seeds=[
    ...
    {key:'dich-vu-5',name:'Dịch vụ · Cửa hàng Laptop',category:'dich-vu',preset:'service_laptop_store_5',price:3000000,renewal:3000000,sort:5,image:'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=1200&q=86',demo:'/demo/dich-vu/cua-hang-laptop/',badge:'CỬA HÀNG LAPTOP',description:'Website trưng bày laptop với danh mục, cấu hình, giá và yêu cầu tư vấn.',features:'Danh mục laptop\nCấu hình & giá rõ ràng\nẢnh laptop thực tế\nHộp yêu cầu tư vấn',accent:'blue'},
