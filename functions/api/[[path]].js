...
async function ensureTemplateCatalog(env){
  ...
  const seeds=[
    ...
    {key:'dich-vu-1',name:'Dịch vụ Mẫu 1 · FPT Telecom',category:'dich-vu',preset:'service_fpt_1',price:1499000,renewal:1999000,sort:1,image:'/assets/demo/dich-vu-1-preview.svg',demo:'/demo/dich-vu/mau-1/',badge:'FPT',description:'Mẫu website đại lý FPT Telecom với gói Internet, FPT Play, Camera AI và combo dịch vụ.',features:'Internet FPT\nFPT Play\nCamera AI\nCombo & CTA tư vấn',accent:'blue'},
    {key:'dich-vu-2',name:'Dịch vụ Mẫu 2 · VNPT',category:'dich-vu',preset:'service_vnpt_2',price:1499000,renewal:1999000,sort:2,image:'/assets/demo/dich-vu-2-preview.svg',demo:'/demo/dich-vu/mau-2/',badge:'VNPT',description:'Mẫu website dịch vụ VNPT với Home Internet, MyTV, Home Cam và combo gia đình.',features:'Home Internet\nMyTV\nHome Cam\nCombo gia đình',accent:'blue'},
    {key:'dich-vu-3',name:'Dịch vụ Mẫu 3 · Viettel',category:'dich-vu',preset:'service_viettel_3',price:1499000,renewal:1999000,sort:3,image:'/assets/demo/dich-vu-3-preview.svg',demo:'/demo/dich-vu/mau-3/',badge:'VIETTEL',description:'Mẫu website Viettel Telecom với Internet Wi-Fi 6, TV360, Camera và combo trọn gói.',features:'Internet Viettel\nTV360\nCamera Cloud\nCombo trọn gói',accent:'red'},
  ...
  for(const [key,cfg] of Object.entries(serviceCommerce)){
    ...
    const sp={version:8,layout_contract:'universal-layout-v1',content_type:'service',geometry_locked:1,route_contract:'service-commerce-v2',card_contract:'service-commerce-card-v2',article_contract:'service-detail-v2',lead_contract:'service-lead-v1',sidebars:[],sections:[
