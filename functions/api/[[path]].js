...
,
  ...
  'blog-ca-nhan-1':{version:6,layout_contract:'universal-layout-v1',content_type:'news',geometry_locked:1,sections:[sec('hero','section','Giới thiệu tác giả',{content_source:'none',bind_required:0}),sec('popular','latest','Đang được đọc nhiều',{slots:6,desktop_columns:3,tablet_columns:2,mobile_columns:1,bind_required:1}),cat(1,'Thương hiệu cá nhân',{slots:6,desktop_columns:3}),cat(2,'Freelance',{slots:6,desktop_columns:3}),cat(3,'Năng suất',{slots:6,desktop_columns:3}),cat(4,'Sách & công cụ',{slots:6,desktop_columns:3}),cat(5,'Lối sống sáng tạo',{slots:6,desktop_columns:3}),cat(6,'Góc nhìn',{slots:6,desktop_columns:3}),sec('newsletter','newsletter','Newsletter')]},
  'blog-ca-nhan-2':{version:6,layout_contract:'universal-layout-v1',content_type:'news',geometry_locked:1,sections:[sec('hero','section','Creator intro',{content_source:'none',bind_required:0}),sec('stories','latest','Stories & case studies',{slots:8,desktop_columns:4,tablet_columns:2,mobile_columns:1,bind_required:1}),cat(1,'Creator business',{slots:6,desktop_columns:3}),cat(2,'Video & production',{slots:6,desktop_columns:3}),cat(3,'Content strategy',{slots:6,desktop_columns:3}),cat(4,'Case study',{slots:6,desktop_columns:3}),cat(5,'Công cụ',{slots:6,desktop_columns:3}),cat(6,'Monetization',{slots:6,desktop_columns:3}),sec('newsletter','newsletter','Newsletter')]},
  'doanh-nghiep-1':{version:6,layout_contract:'universal-layout-v1',content_type:'generic',geometry_locked:1,sections:[sec('hero','section','Giới thiệu doanh nghiệp',{content_source:'none',bind_required:0}),sec('services','services','Giải pháp',{content_source:'none',bind_required:0}),sec('case','section','Case study',{content_source:'none',bind_required:0}),cat(1,'Chuyển đổi số',{slots:6,desktop_columns:3}),cat(2,'Vận hành',{slots:6,desktop_columns:3}),cat(3,'Dữ liệu & BI',{slots:6,desktop_columns:3}),cat(4,'Khách hàng',{slots:6,desktop_columns:3}),cat(5,'Nhân sự',{slots:6,desktop_columns:3}),cat(6,'Tin doanh nghiệp',{slots:6,desktop_columns:3})]},
  'doanh-nghiep-2':{version:6,layout_contract:'universal-layout-v1',content_type:'generic',geometry_locked:1,sections:[sec('hero','section','Hồ sơ năng lực',{content_source:'none',bind_required:0}),sec('capabilities','services','Năng lực kỹ thuật',{content_source:'none',bind_required:0}),sec('projects','section','Dự án',{content_source:'none',bind_required:0}),cat(1,'Sản xuất',{slots:6,desktop_columns:3}),cat(2,'Cơ khí & CNC',{slots:6,desktop_columns:3}),cat(3,'QA/QC',{slots:6,desktop_columns:3}),cat(4,'HSE',{slots:6,desktop_columns:3}),cat(5,'Dự án',{slots:6,desktop_columns:3}),cat(6,'Bảo trì',{slots:6,desktop_columns:3})]},
  'dich-vu-5':{version:6,layout_contract:'universal-layout-v1',content_type:'service',geometry_locked:1,sections:[sec('hero','section','Điểm sạc xe điện',{content_source:'none',bind_required:0}),sec('stations','section','Điểm sạc gần bạn',{content_source:'none',bind_required:0}),sec('services','services','Giải pháp sạc',{content_source:'none',bind_required:0}),cat(1,'Kiến thức sạc',{slots:6,desktop_columns:3}),cat(2,'Lắp đặt tại nhà',{slots:6,desktop_columns:3}),cat(3,'Điểm sạc công cộng',{slots:6,desktop_columns:3}),cat(4,'Kỹ thuật điện',{slots:6,desktop_columns:3}),cat(5,'Bảo trì',{slots:6,desktop_columns:3}),cat(6,'Vận hành đội xe',{slots:6,desktop_columns:3}),sec('contact','section','Đăng ký khảo sát',{content_source:'none',bind_required:0})]},
