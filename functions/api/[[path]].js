...
,
  ...
  'dich-vu-5':{version:7,layout_contract:'universal-layout-v1',content_type:'service',geometry_locked:1,settings_schema:proSettings,lead_contract:'service-lead-v1',sections:[sec('hero','section','Điểm sạc xe điện',{content_source:'none',bind_required:0}),sec('stations','section','Điểm sạc gần bạn',{content_source:'none',bind_required:0}),sec('services','services','Giải pháp sạc',{content_source:'none',bind_required:0}),cat(1,'Kiến thức sạc',{slots:6,desktop_columns:3}),cat(2,'Lắp đặt tại nhà',{slots:6,desktop_columns:3}),cat(3,'Điểm sạc công cộng',{slots:6,desktop_columns:3}),cat(4,'Kỹ thuật điện',{slots:6,desktop_columns:3}),cat(5,'Bảo trì',{slots:6,desktop_columns:3}),cat(6,'Vận hành đội xe',{slots:6,desktop_columns:3}),sec('contact','section','Đăng ký khảo sát',{content_source:'none',bind_required:0})]},
