...
async function ensureTemplateCatalog(env){
  ...
  const seeds=[
    ...
    {key:'blog-ca-nhan-1',name:'Blog cá nhân · Minimal Journal',category:'blog-ca-nhan',preset:'personal_blog_1',price:1499000,renewal:1999000,sort:1,image:'/assets/demo/blog-ca-nhan-1-preview.png',demo:'/demo/blog-ca-nhan/mau-1/',badge:'BLOG CÁ NHÂN',description:'Mẫu blog cá nhân tối giản cho blogger, chuyên gia và freelancer.',features:'Hero giới thiệu cá nhân\nBài viết nổi bật\nTrang giới thiệu / liên hệ\nTối ưu SEO nội dung',accent:'violet'},
    {key:'blog-ca-nhan-2',name:'Blog cá nhân · Creator Notes',category:'blog-ca-nhan',preset:'personal_blog_2',price:1499000,renewal:1999000,sort:2,image:'/assets/demo/blog-ca-nhan-2-preview.png',demo:'/demo/blog-ca-nhan/mau-2/',badge:'CREATOR',description:'Website creator kết hợp blog, portfolio và newsletter.',features:'Blog + portfolio\nNewsletter\nChuyên mục nội dung\nCTA hợp tác',accent:'orange'},
    {key:'doanh-nghiep-1',name:'Doanh nghiệp · Modern Solutions',category:'doanh-nghiep',preset:'corporate_modern_1',price:1699000,renewal:2199000,sort:1,image:'/assets/demo/doanh-nghiep-1-preview.png',demo:'/demo/doanh-nghiep/mau-1/',badge:'DOANH NGHIỆP',description:'Website công ty hiện đại với dịch vụ, năng lực, dự án và CTA tư vấn.',features:'Giới thiệu công ty\nDịch vụ & năng lực\nDự án\nForm tư vấn',accent:'blue'},
    {key:'doanh-nghiep-2',name:'Doanh nghiệp · Industrial Pro',category:'doanh-nghiep',preset:'corporate_industry_2',price:1799000,renewal:2299000,sort:2,image:'/assets/demo/doanh-nghiep-2-preview.png',demo:'/demo/doanh-nghiep/mau-2/',badge:'CÔNG NGHIỆP',description:'Website công ty sản xuất, xây dựng và kỹ thuật với hồ sơ năng lực online.',features:'Năng lực sản xuất\nDự án tiêu biểu\nChứng nhận / đối tác\nNhận báo giá',accent:'slate'},
    {key:'dich-vu-5',name:'Điểm sạc xe điện · VinFast Charging',category:'dich-vu',preset:'service_ev_charge_5',price:1599000,renewal:2099000,sort:5,image:'/assets/demo/dich-vu-5-preview.png',demo:'/demo/dich-vu/tram-sac-vinfast/',badge:'TRẠM SẠC EV',description:'Website dịch vụ cung cấp, lắp đặt và tra cứu điểm sạc xe điện VinFast.',features:'Điểm sạc & khu vực\nGói lắp đặt\nQuy trình khảo sát\nCTA tư vấn',accent:'cyan'},
