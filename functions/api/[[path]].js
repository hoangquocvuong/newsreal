...
,
  ...
  'doanh-nghiep-1':{version:7,layout_contract:'universal-layout-v1',content_type:'news',geometry_locked:1,settings_schema:proSettings,sections:[sec('hero','section','Giới thiệu doanh nghiệp',{content_source:'none',bind_required:0}),sec('services','services','Giải pháp',{content_source:'none',bind_required:0}),sec('case','section','Dự án tiêu biểu',{content_source:'none',bind_required:0}),cat(1,'Chuyển đổi số',{slots:6,desktop_columns:3}),cat(2,'Vận hành',{slots:6,desktop_columns:3}),cat(3,'Dữ liệu & phân tích',{slots:6,desktop_columns:3}),cat(4,'Khách hàng',{slots:6,desktop_columns:3}),cat(5,'Nhân sự',{slots:6,desktop_columns:3}),cat(6,'Tin doanh nghiệp',{slots:6,desktop_columns:3}),sec('contact','section','Liên hệ doanh nghiệp',{content_source:'none',bind_required:0})]},
  'doanh-nghiep-2':{version:7,layout_contract:'universal-layout-v1',content_type:'news',geometry_locked:1,settings_schema:proSettings,sections:[sec('hero','section','Hồ sơ năng lực',{content_source:'none',bind_required:0}),sec('capabilities','services','Năng lực kỹ thuật',{content_source:'none',bind_required:0}),sec('projects','section','Dự án',{content_source:'none',bind_required:0}),cat(1,'Sản xuất',{slots:6,desktop_columns:3}),cat(2,'Cơ khí & CNC',{slots:6,desktop_columns:3}),cat(3,'Quản lý chất lượng',{slots:6,desktop_columns:3}),cat(4,'An toàn lao động',{slots:6,desktop_columns:3}),cat(5,'Dự án',{slots:6,desktop_columns:3}),cat(6,'Bảo trì',{slots:6,desktop_columns:3}),sec('contact','section','Nhận báo giá',{content_source:'none',bind_required:0})]},
...
async function ensureTemplateCatalog(env){
  ...
  const seeds=[
    ...
    {key:'doanh-nghiep-2',name:'Doanh nghiệp · Công nghiệp chuyên nghiệp',category:'doanh-nghiep',preset:'corporate_industry_2',price:1799000,renewal:2299000,sort:2,image:'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?auto=format&fit=crop&w=1200&q=82',demo:'/demo/doanh-nghiep/mau-2/',badge:'CÔNG NGHIỆP',description:'Website công ty sản xuất, xây dựng và kỹ thuật với hồ sơ năng lực online.',features:'Năng lực sản xuất\nDự án tiêu biểu\nChứng nhận / đối tác\nNhận báo giá',accent:'slate'},
  ...
  // V20.9.26.0 — Professional template Admin contracts: exact taxonomy + contact settings.
  const professionalEditors={
    ...
    'doanh-nghiep-2':{id:'news',label:'Bài viết kỹ thuật & dự án',content_type:'news',categories:['Sản xuất','Cơ khí & CNC','Quản lý chất lượng','An toàn lao động','Dự án','Bảo trì'],contentLabel:'Nội dung kỹ thuật / dự án',contentHelp:'Chọn chuyên mục chính xác để bài hiển thị đúng khối năng lực, dự án hoặc chuyên san.',custom_fields:[{key:'project_location',label:'Địa điểm dự án',type:'text'},{key:'project_scope',label:'Phạm vi công việc',type:'text'}]},
