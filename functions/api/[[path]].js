...
,
  ...
  'blog-ca-nhan-1':{version:1,layout_contract:'universal-layout-v1',content_type:'news',geometry_locked:1,sections:[sec('hero','section','Giới thiệu tác giả',{content_source:'none',bind_required:0}),sec('latest','latest','Bài viết mới',{slots:6,desktop_columns:3,tablet_columns:2,mobile_columns:1,bind_required:1})]},
  'blog-ca-nhan-2':{version:1,layout_contract:'universal-layout-v1',content_type:'news',geometry_locked:1,sections:[sec('hero','section','Creator intro',{content_source:'none',bind_required:0}),sec('latest','latest','Bài viết & Portfolio',{slots:6,desktop_columns:3,tablet_columns:2,mobile_columns:1,bind_required:1})]},
  'doanh-nghiep-1':{version:1,layout_contract:'universal-layout-v1',content_type:'generic',geometry_locked:1,sections:[sec('hero','section','Giới thiệu doanh nghiệp',{content_source:'none',bind_required:0}),sec('services','services','Dịch vụ',{content_source:'none',bind_required:0}),sec('stats','stats','Năng lực',{content_source:'none',bind_required:0})]},
  'doanh-nghiep-2':{version:1,layout_contract:'universal-layout-v1',content_type:'generic',geometry_locked:1,sections:[sec('hero','section','Hồ sơ năng lực',{content_source:'none',bind_required:0}),sec('services','services','Năng lực',{content_source:'none',bind_required:0}),sec('stats','stats','Dự án',{content_source:'none',bind_required:0})]},
  'dich-vu-5':{version:1,layout_contract:'universal-layout-v1',content_type:'service',geometry_locked:1,sections:[sec('hero','section','Điểm sạc xe điện',{content_source:'none',bind_required:0}),sec('services','services','Giải pháp sạc',{content_source:'none',bind_required:0}),sec('contact','section','Đăng ký khảo sát',{content_source:'none',bind_required:0})]},
