...
const required=[
  ...
  ['Game structure profile',"'game-1':{version:15,layout_contract:'universal-layout-v1'"],
  ...
  ['backend Game article sidebar contract',"article_sidebar_contract:'game-rich-sticky-sidebar-v1'"],
