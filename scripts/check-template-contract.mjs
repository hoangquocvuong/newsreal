...
const required=[
  ...
  ['Game structure profile',"'game-1':{version:16,layout_contract:'universal-layout-v1'"],
  ...
  ['backend Game article sidebar contract',"article_sidebar_contract:'game-cta-last-sticky-v2'"],
