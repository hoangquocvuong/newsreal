...
const required=[
  ...
  ['Game structure profile',"'game-1':{version:3,layout_contract:'universal-layout-v1'"],
  ['Game community archive route','/bases?'],
  ['Game fast filter binding','nrGameBindFastFilters'],
  ['Game mobile compact detail CSS','.coc-detail-copy .coc-tags,.coc-detail-copy h1,.coc-article-body{display:none!important}'],
